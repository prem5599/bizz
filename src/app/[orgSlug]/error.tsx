...
export default function Error({ error, reset }: ErrorProps) {
  ...
  useEffect(() => {
    ...
    console.error(`Organization route error for ${orgSlug}:`, error)
  }, [error, orgSlug])
      ...
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-6">
            We encountered an error loading this organization's page. Please try again or contact support if the problem persists.
          </p>
